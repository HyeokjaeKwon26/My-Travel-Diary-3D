...
**[📥 Android 앱 다운로드](https://github.com/HyeokjaeKwon26/My-Travel-Diary-3D/releases/tag/v1.0.0-rc12)** · **[처음 사용하는 분을 위한 안내](docs/INSTALLATION_3D.md)** · **[문제·의견 보내기](https://github.com/HyeokjaeKwon26/My-Travel-Diary-3D/issues)**

Android 8.0 이상 · 휴대폰·태블릿 · 현재 공개 버전 **1.0.0-rc12 (시험 배포)**

<img src="docs/verification-3d/rc12-controls-landscape.png" width="960" alt="그랜드 캐니언 예시 여행을 가로 전체화면으로 재생하는 모습. 3D 지형 위로 자동차와 경로가 보이고 날짜와 재생 시간을 확인할 수 있습니다." />
...
- **크게 보고, 원하는 순간으로 이동하세요.** 전체화면과 가로보기를 지원합니다. 현재 시간·전체 재생 시간을 보면서 원하는 지점으로 이동하거나 재생 속도를 바꿀 수 있습니다. 조작부는 재생 중 잠시 후 사라지고, 화면을 터치하면 다시 나타나 지도를 넓게 감상할 수 있습니다.
...
**JSON 파일은 이렇게 준비하세요 — 갤럭시 등 Android 기준**

1. 여행 기록이 저장된 휴대폰의 **설정** 앱을 엽니다.
2. **위치 → 위치 서비스 → 타임라인**으로 들어갑니다.
3. **타임라인 데이터 내보내기 → 계속**을 누릅니다.
4. **Download / 다운로드**처럼 찾기 쉬운 폴더에 저장하고 내보내기가 끝날 때까지 기다립니다.
5. My Travel Diary 3D에서 **+ New Travel Story → Choose Timeline JSON File**을 누르고 방금 저장한 **`.json` 파일**을 선택합니다.

메뉴 이름은 기기에 따라 다를 수 있습니다. 메뉴가 없거나 기록이 비어 있다면 [사용 안내의 준비 과정과 해결 방법](docs/INSTALLATION_3D.md#timeline-export)을 확인하세요. 내보내기 순서는 [Google 공식 안내](https://support.google.com/maps/answer/6258979?co=GENIE.Platform%3DAndroid&hl=ko)를 참고했습니다.

**사진은 따로 압축하거나 업로드하지 않아도 됩니다.** 여행 사진 원본을 휴대폰에 보관하고, 새 여행 화면의 **Enable**을 눌러 사진 접근을 허용하세요. 일부 사진만 허용하면 그 사진들만 사용할 수 있습니다. Google 포토 등 클라우드에만 있는 사진은 먼저 기기에 내려받아 주세요.
