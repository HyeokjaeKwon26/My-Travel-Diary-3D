...
/**
 * EGL-backed MediaCodec input surface helper (P0-01, P0-02).
 *
 * Provides a hardware-accelerated EGL context and OpenGL ES 2.0 texture quad renderer
 * to submit rendered Canvas bitmaps to MediaCodec with explicit presentation timestamps
 * via [EGLExt.eglPresentationTimeANDROID].
 */
class CodecInputSurface(
    ...
    init {
        ...
        // Texture coordinates mapped to compensate for Canvas top-left vs GL bottom-left
    ...
    fun drawFrame(bitmap: Bitmap, presentationTimeNs: Long, clear: Boolean = true) {
        ...
        // P0-01: Explicit presentation timestamp bound directly to frame
